...
# leaves pgokf.bundles.okf_version NULL and never aborts a sync. A declared
# but UNSUPPORTED version (this build supports 0.2 / 0.2.x) is warned about
# and indexed anyway by default; the okf_version_policy config key set to
# "reject" makes it abort the sync instead.
okf_version: "0.2"
---

...
%changelog
* Tue Sep 22 2026 David Saroka <david.saroka@gmail.com> - 0.3.1-1
- Recover unpublished 0.3.0; stable PostgreSQL 15-18, PG19 Beta 3 CI only.

* Tue Sep 22 2026 David Saroka <david.saroka@gmail.com> - 0.3.0-1
- Release 0.3.1: generic producer capabilities - catalog generations and
  ...
  pgokf--0.3.0-dev3--0.3.0.sql and pgokf--0.3.0--0.3.1.sql; additive and data-preserving.
...
- Release 0.1.15: BM25 provider selection (bm25_provider policy key) adds Tiger
  ...
  and 18. Upgrade script pgokf--0.1.14--0.1.15.sql adds the column.
